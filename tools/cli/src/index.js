...
program
  ...
  .action(() => {
    ...
    console.log(
      "  aport verify -a ap_128094d3 -p payments.refund.v1 -c '{\"amount\":50}'"
    );
    console.log(
      "  aport policy -a agt_tmpl_mg8jr8l1_geckvz -p data.export.v1 -c '{\"rows\":1000}'"
    );
    console.log("  aport get-passport -a ap_128094d3");
    console.log(chalk.yellow("\nWith API Key:"));
