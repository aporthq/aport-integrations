...
npm start verify ap_128094d3 payments.refund.v1 '{"amount":50}'

# Or using options
npm start verify -a ap_128094d3 -p payments.refund.v1 -c '{"amount":50}'
...
aport get-passport -a ap_128094d3
```
